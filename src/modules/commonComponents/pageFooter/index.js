      ...
      <DivColumn fillSelfHorizontal className={styles.footer_container}>
        <DivRow className={styles.footer_content}>
          <DivColumn className={styles.footer_link_container}>
            <b className={styles.link_header}>
              {translate("footer.title_app")}
            </b>
            <a className={styles.link} href="/">
              {translate("footer.home")}
            </a>
            <a className={styles.link} href="/profile">
              {translate("footer.profile")}
            </a>
            <a className={styles.link} href="/wishlist">
              {translate("footer.wishlist")}
            </a>
            <a className={styles.link} href="/profile/heplcenter">
              {translate("footer.helpcenter")}
            </a>
            <a className={styles.link} href="/profile/settings">
              {translate("footer.settings")}
            </a>
          </DivColumn>
          <DivColumn className={styles.footer_link_container}>
            <b className={styles.link_header}>
              {translate("footer.title_link")}
            </b>
            ...
            <a className={styles.link} href="/terms-and-condition">
              {translate("footer.terms")}
            </a>
            <a className={styles.link} href="/shipping-and-returns">
              {translate("footer.shipping")}
            </a>
          </DivColumn>
          <DivColumn className={styles.footer_link_container}>
            <b className={styles.link_header}>
              {translate("footer.experience")}
            </b>
            ...
            <b className={styles.link_header} style={{ marginTop: 16 }}>
              {translate("footer.keep_in_touch")}
            </b>
            <DivRow>
